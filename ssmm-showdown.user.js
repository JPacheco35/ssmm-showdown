// ==UserScript==
// @name         Custom Showdown Music Mod
// @namespace    https://github.com/JPacheco35/ssmm-showdown
// @version      0.41
...
BattleScene = function () {
    ...
    _proto.
        ...
        console.log("this.battle.gen = " + this.battle.gen)

        // Different Music Depending on the Generation of the Battle
        switch(this.battle.gen)
        {

            // Gen 1 Battles (RBY)
            case 1:
                this.bgmNum = (1 + this.numericId % 3);

                switch(this.bgmNum)
                {
                    // Vs Trainer (RBY)
                    case 1:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-red-green-blue-yellow/lfakpvxalk/10.%20Battle%21%20%28Trainer%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader (RBY)
                    case 2:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-red-green-blue-yellow/ppdgehuibt/28.%20Battle%21%20%28Gym%20Leader%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Champion (RBY)
                    case 3:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-red-green-blue-yellow/pvfhbfvjzj/51%20Final%20Battle%21%20%28Rival%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Default : Vs Trainer (We should never get here)
                    default:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-red-green-blue-yellow/lfakpvxalk/10.%20Battle%21%20%28Trainer%29.mp3',1661, 68131, this.bgm)
                        break;
                }
            ...
            // Gen 2 Battles (GSC)
            case 2:
                this.bgmNum = (1 + this.numericId % 8);

                switch(this.bgmNum)
                {
                    // Vs Rival (GSC)
                    case 1:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/jvybknfkss/29.%20Battle%21%20%28Rival%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer - Johto (GSC)
                    case 2:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/xwgjjpsoqs/35.%20Battle%21%20%28Trainer%20-%20Johto%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader - Johto (GSC)
                    case 3:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/aynrugmjen/42.%20Battle%21%20%28Gym%20Leader%20-%20Johto%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Team Rocket (GSC)
                    case 4:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/pkzvdprolz/56.%20Battle%21%20%28Team%20Rocket%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Champion (GSC)
                    case 5:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/fozoptyemi/101.%20Battle%21%20%28Champion%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader - Johto (GSC)
                    case 6:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/kcykqrcldp/105.%20Battle%21%20%28Trainer%20-%20Kanto%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer - Kanto (GSC)
                    case 7:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/aynrugmjen/42.%20Battle%21%20%28Gym%20Leader%20-%20Johto%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader - Kanto (GSC)
                    case 8:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/kcykqrcldp/105.%20Battle%21%20%28Trainer%20-%20Kanto%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Default : Vs Trainer - Johto (We should never get here)
                    default:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-gold-silver-crystal/xwgjjpsoqs/35.%20Battle%21%20%28Trainer%20-%20Johto%29.mp3',1661, 68131, this.bgm)
                        break;
                }
            ...
            // Gen 3 Battles (ADV)
            case 3:
                this.bgmNum = (1 + this.numericId % 11);

                switch(this.bgmNum)
                {
                    // Vs Gym Leader (RSE)
                    case 1:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/rdmcwecwyz/1-33%20Gym%20Leader%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer (RSE)
                    case 2:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/yfkfuwabbo/1-16%20Trainer%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Team Aqua/Magma
                    case 3:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/ualaucmbsx/1-27%20Team%20Aqua%20-%20Magma%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Rival (RSE)
                    case 4:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/dvegqzutny/1-66%20Rival%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Archie/Maxie (RSE)
                    case 5:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/elzenzyapl/1-83%20Archie%20-%20Maxie%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Elite 4 (RSE)
                    case 6:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/mikrckclto/1-99%20Elite%20Four%20Member%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Champion (RSE)
                    case 7:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/srpjqhhgmk/1-101%20Champion%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer (LGFR)
                    case 8:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-leafgreen-2004-gba/jsupryxluh/11%20Battle%20%28VS%20Trainer%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader (LGFR)
                    case 9:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-leafgreen-2004-gba/mggkmeggov/27%20Battle%20%28VS%20Gym%20Leader%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Champion (LGFR)
                    case 10:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-leafgreen-2004-gba/xrwwtvwcgc/70%20The%20Last%20Battle%20%28VS%20Rival%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Frontier Brain (RSE)
                    case 11:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/njwepwmara/2-15%20Frontier%20Brain%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;

                    // Default : Vs Trainer (RSE) (We should never get here)
                    default:
                        this.bgm = BattleSound.loadBgm('https://kappa.vgmsite.com/soundtracks/pokemon-emerald-enhanced-soundtrack/yfkfuwabbo/1-16%20Trainer%20Battle%21.mp3',1661, 68131, this.bgm)
                        break;
                }
            ...
            // Gen 4 Battles (DPPT)
            case 4:
                this.bgmNum = (1 + this.numericId % 17);

                switch(this.bgmNum)
                {
                    // Vs Cynthia (DPPT)
                    case 1:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/agmpuios/2-67.%20Battle%21%20%28Champion%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Elite 4 (DPPT)
                    case 2:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/lxtkivcu/2-64.%20Battle%21%20%28Elite%20Four%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Cyrus (DPPT)
                    case 3:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/exaaoiib/1-65.%20Battle%21%20%28Team%20Galactic%20Boss%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Galactic Admin (DPPT)
                    case 4:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/utvaussv/1-46.%20Battle%21%20%28Team%20Galactic%20Commander%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Galactic (DPPT)
                    case 5:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/uxtwotzp/1-41.%20Battle%21%20%28Team%20Galactic%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Rival (DPPT)
                    case 6:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/kmmsdvnp/1-26.%20Battle%21%20%28Rival%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer (DPPT)
                    case 7:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/kbqajyde/1-20.%20Battle%21%20%28Trainer%20Battle%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader (DPPT)
                    case 8:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-diamond-and-pearl-super-music-collection/lgyowmjx/1-32.%20Battle%21%20%28Gym%20Leader%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Frontier Brain (DPPT)
                    case 9:
                        this.bgm = BattleSound.loadBgm('https://vgmsite.com/soundtracks/pok-mon-diamond-pok-mon-pearl-super-music-collection-2006/efxiqcrrss/183.%20Battle%21%20%28Frontier%20Brain%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Giratina
                    case 10:
                        this.bgm = BattleSound.loadBgm('https://vgmsite.com/soundtracks/pok-mon-diamond-pok-mon-pearl-super-music-collection-2006/fobcpuuyin/89.%20Battle%21%20%28Giratina%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Champion (HGSS)
                    case 11:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/vkvdahkuiq/2-78.%20Battle%21%20%28Champion%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer - Kanto (HGSS)
                    case 12:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/nccyaoyxxt/2-29.%20Battle%21%20%28Trainer%20Battle%E2%80%94Kanto%20Version%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader - Kanto (HGSS)
                    case 13:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/vjkkzehscy/2-04.%20Battle%21%20%28Gym%20Leader%E2%80%94Kanto%20Version%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Gym Leader - Johto (HGSS)
                    case 14:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/mqeqitakqm/1-43.%20Battle%21%20%28Gym%20Leader%E2%80%94Johto%20Version%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Team Rocket (HGSS)
                    case 15:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/cslqyfoxyn/1-35.%20Battle%21%20%28Team%20Rocket%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Trainer - Johto (HGSS)
                    case 16:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/rbjhxendsk/1-18.%20Battle%21%20%28Trainer%20Battle%E2%80%94Johto%20Version%29.mp3',1661, 68131, this.bgm)
                        break;

                    // Vs Rival (HGSS)
                    case 17:
                        this.bgm = BattleSound.loadBgm('https://eta.vgmtreasurechest.com/soundtracks/pokemon-heartgold-and-soulsilver-music-super-complete/bgluyxedcz/1-38.%20Battle%21%20%28Rival%29.mp3',1661, 68131, this.bgm)
                        break;
